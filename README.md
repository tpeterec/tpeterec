...
Check out my most recent project: fs_pet_shop (Using PostgreSQL, RESTful APIs, Docker, and Express.JS to make a server side project with a petshop inventory) 
